                ...
                <div className="mt-10 leading-10">
                  ...
                  <div className="flex flex-col justify-between md:flex-row">
                    {weatherData.forecast.forecastday
                      .slice(1, 5)
                      .map((day, index) => (
                        <div className="bg-gray-400 p-5 text-white border border-dotted border-white" key={index}>
                          ...
                          <ul>
                            <li>
                              Temp:{" "}
                              <span className="">{day.day.avgtemp_c}</span>
                              &deg;C
                            </li>
                            <li>
                              Wind:{" "}
                              <span className="">{day.day.maxwind_mph}</span>{" "}
                              M/S
                            </li>
                            <li>
                              Humidity:{" "}
